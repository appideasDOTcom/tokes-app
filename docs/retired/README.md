...
|---|---|---|
| `coverage-report-2026-08-19.md` | The submission-baseline coverage audit and the full work log that closed it out — 13 findings, ranked recommendations, three phases of close-out, and four re-measurements. Superseded for *current* state by `../coverage-report-2026-08-20.md`, which is a fresh measurement rather than a continuation. Moved verbatim; its internal path references point at the old flat layout. | 2026-08-20 |
